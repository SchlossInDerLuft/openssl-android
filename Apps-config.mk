...
target_c_includes := $(addprefix $(NDK_PROJECT_PATH)/,$(common_c_includes)) $(local_c_includes)
...
host_c_includes := $(addprefix $(NDK_PROJECT_PATH)/,$(common_c_includes)) $(local_c_includes)
